...
SaveNewStaticAdress() {
    FileDelete, ConfigEndGame.txt
    ; Utiliser un caractère spécial (par exemple, "`n") pour séparer les valeurs sur la même ligne
    FileAppend,%duree4%`n%dureeCouleur4%`n%duree1%`n%dureeCouleur1%`n%duree2%`n%dureeCouleur2%`n%duree3%`n%dureeCouleur3%`n%potion4%`n%couleur4%`n%potion1%`n%couleur1%`n%potion2%`n%couleur2%`n%potion3%`n%couleur3%, ConfigEndGame.txt
}

LoadOptions() {
    FilePath := "ConfigEndGame.txt"
    if (FileExist(FilePath)) {
        ...
        FileReadLine, duree3, %FilePath%, 5
        FileReadLine, dureeCouleur3, %FilePath%, 6
        FileReadLine, duree4, %FilePath%, 7
        FileReadLine, dureeCouleur4, %FilePath%, 8
        ; Lire les trois premières lignes
        FileReadLine, potion1, %FilePath%, 9
        FileReadLine, couleur1, %FilePath%, 10
        FileReadLine, potion2, %FilePath%, 11
        FileReadLine, couleur2, %FilePath%, 12
        FileReadLine, potion3, %FilePath%, 13
        FileReadLine, couleur3, %FilePath%, 14
        FileReadLine, potion4, %FilePath%, 15
        FileReadLine, couleur4, %FilePath%, 16
